...
const GameArea = ({
    ...
    let filteredLocations: GraphLocation[] = region.locations.filter((location) => showAreaLocations && locationFilter(location, alwaysExpanded, collapsedRegions, filter_title, showHints, region.is_not_required, lastLocationName, simMode, peekedLocations, searchTerm));
    let filteredEntrances: GraphEntrance[] = region.exits.filter((entrance) => 
        ...
        entranceOrTargetMatchesTerm(entrance, alwaysExpanded, collapsedRegions, filter_title, searchTerm, showEntranceLocations, showShops, showHints, region.is_not_required, lastLocationName, simMode, peekedLocations)).sort((a, b) => a.type_priority - b.type_priority || a.alias.localeCompare(b.alias));
    ...
    filteredLocations = region.local_locations.filter((location) => showAreaLocations && locationFilter(location, alwaysExpanded, collapsedRegions, filter_title, showHints, region.is_not_required, lastLocationName, simMode, peekedLocations, searchTerm));
