...
const itemMap: IconDict = {
    ...
    'Triforce of Power': { img: '/images/triforce_of_power.png' },
    'Triforce of Wisdom': { img: '/images/triforce_of_wisdom.png' },
    'Triforce of Courage': { img: '/images/triforce_of_courage.png' },
