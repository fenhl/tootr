...
const itemMap: IconDict = {
    ...
    'Triforce of Power': { img: '/images/OoT_Triforce.png', rSub: 'P' },
    'Triforce of Wisdom': { img: '/images/OoT_Triforce.png', rSub: 'W' },
    'Triforce of Courage': { img: '/images/OoT_Triforce.png', rSub: 'C' },
