...
const TrackerPaper = ({
    ...
    */
    ...
    let cards = viewableRegions.map((region, regionIndex) => {
        ...
        let filteredLocations: GraphLocation[] = region.locations.filter((location) => showAreaLocations && locationFilter(location, alwaysExpanded, collapsedRegions, title, showHints, region.is_not_required, lastLocationName, simMode, peekedLocations, searchTerm));
